...
### Получение письма
Для получения письма сначала будут взяты заголовки и ссылка на тело из БД. Затем получено само тело, В котором могут быть вложения. На месте вложений будут ссылки на S3. 
